...
const prossimiAppuntamenti = [
    {
        id: 1,
        tipo: "Visita",
        descrizione: "Cardiologo Dr. Bianchi",
        data: "15 Nov",
        ora: "15:30",
    },
    {
...
const caregivers = [
    {
        ...
        nome: "Maria Rossi",
        ruolo: "Figlia",
        disponibilità: "Lun-Ven 18:00-22:00",
    },
    { id: 2, nome: "Paolo Rossi", ruolo: "Figlio", disponibilità: "Weekend" },
    {
        ...
        nome: "Anna Verdi",
        ruolo: "Assistente",
        disponibilità: "Lun-Ven 09:00-17:00",
    },
];
...
const interazioniRecenti = [
    {
        id: 1,
        tipo: "Promemoria",
        descrizione: "Prendere medicina",
        quando: "2 ore fa",
    },
    {
        id: 2,
        tipo: "Chat",
        descrizione: "Chiesto info sul prossimo appuntamento",
        quando: "4 ore fa",
    },
    {
        id: 3,
        tipo: "Chiamata",
        descrizione: "Chiamata a Maria",
        quando: "Ieri 18:30",
    },
];
                ...
                >
                    <HStack className="justify-between items-center">
                        ...
                        <Badge size="lg" variant="solid" action="success">
                            <BadgeText>
                                Ultima interazione: {paziente.ultimaInterazione}
                            </BadgeText>
                        </Badge>
                    </HStack>
                </Card>
                    ...
                    <Card className="p-6">
                        ...
                        <VStack space="md">
                            {medicineOggi.map((medicina) => (
                                <HStack
                                    key={medicina.id}
                                    className="justify-between items-center p-3 bg-background-50 rounded"
                                >
                                    <VStack space="xs">
